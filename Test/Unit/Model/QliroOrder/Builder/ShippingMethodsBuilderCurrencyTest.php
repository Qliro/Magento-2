...
/**
 * @see \Qliro\QliroOne\Model\QliroOrder\Builder\ShippingMethodsBuilder::collectShippingMethods
 *
 * PLIN-376: the rate price is converted into the quote's own currency through the quote's own
 * store. The preset address cases of the same class live in ShippingMethodsBuilderTest.
 */
class ShippingMethodsBuilderCurrencyTest extends TestCase
{
